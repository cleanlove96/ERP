	...
	<div align="center">
		<div class="x-body">
			<form class="layui-form">
				...
				<input id="reimbursementId" hidden="" value="${reimbursement.reimbursementId }">
				<input  id="quzhi" hidden="" value="${reimbursement.reimbursementId }">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="costItem" autocomplete="off"
							class="layui-input" name="costItem" lay-verify="requireds" value="${reimbursement.costItem }">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
					 ...
					 -->
					 <div class="layui-input-inline">
						<input type="text" id="reimbursementRespon" autocomplete="off"
							class="layui-input" name="reimbursementRespon" lay-verify="requireds" value="${reimbursement.reimbursementRespon }">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="costTotal" autocomplete="off"
							class="layui-input" name="costTotal" lay-verify="requireds" value="${reimbursement.costTotal }">
					</div>
					<div class="layui-form-mid layui-word-aux"></div>
				</div>
				<div class="layui-form-item">
		...
		document.getElementById("costType").value =$("#quzhi").val() ;
			//框架原有的
			//加载时间的方法
			...
			layui.use([ 'form', 'layer' ], function() {
				...
				form.on('submit(edit)', function(data) {
					...
					$.ajax({
						url : 'approvalController/updateRei.ajax',
						type : 'post',
						data : {
