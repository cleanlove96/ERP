			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="yearNum" autocomplete="off"
						class="layui-input" name="yearNum" lay-verify="requireds">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="goodsSum" autocomplete="off"
						class="layui-input" name="goodsSum" lay-verify="requireds">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="开始时间" id="startTime"
						type="text" name="startTime" lay-verify="requireds">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_name" class="layui-form-label"> <span
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="结束时间" id="endTime"
						type="text" name="endTime" lay-verify="requireds">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="yearpanlVariety" autocomplete="off"
						class="layui-input" name="yearpanlVariety" >
				</div>
...
//执行增加操作
		layui.use(['form','layer'], function(){
			...
			$.ajax({
				url :'yearplanController/yearplanAdd.ajax',
				type:'POST',
				data:yearplans,
				dataType : 'text',
				success : function(res) {
