...
<body>
	<div class="x-body">
		<form class="layui-form">
			<input type="hidden" name="fixedAssetsId"
				value="${fixedAssets.fixedAssetsId }">
			<div class="layui-form-item">
				<label for="L_num" class="layui-form-label"> 编号</label>
				<div class="layui-input-inline">
					<input type="text" id="L_num" name="fixedAssetsNum"
						readonly="readonly" class="layui-input"
						value="${fixedAssets.fixedAssetsNum }">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_name" name="fixedAssetsName" required
						...
						value="${fixedAssets.fixedAssetsName }">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_price" name="fixedAssetsPrice" required
						lay-verify="required" autocomplete="off" class="layui-input"
						value="${fixedAssets.fixedAssetsPrice }">
				</div>
			</div>
			<div class="layui-form-item">
	...
	<script>
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(save)', function(data) {
				$.post('fixedAssetsController/updateFixedAssets.ajax', data.field,
						function(res) {
							if (res == "SUCCESS") {
								//res就是返回的结果
								layer.alert("修改成功", {
