...
<body>
	<div class="x-body">
		<form class="layui-form" onsubmit="return addWH()">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="warehouseName" autocomplete="off" name="warehouseName"  lay-verify="required"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="warehouseDesc" autocomplete="off" name="warehouseDesc"  lay-verify="required"
						class="layui-input">
				</div>
	...
	<script>
		...
		function addWH() {
			...
			$.ajax({
				url : 'wareHouseController/add.do',
				data : {
