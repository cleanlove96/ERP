...
<body>
	...
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a>用户管理</a> <a> <cite>仓库管理</cite></a>
	...
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so" action="wareHouseController/sreach.do">
		...
		<xblock>
			...
			<button class="layui-btn"
				onclick="x_admin_show('添加仓库','view/warehouse/warehouse_add.jsp',500,500)">
