...
<body class="layui-anim layui-anim-up">
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$.ajax({
				url : 'financialManagementController/getSaleTjPage.ajax',
				type : 'POST',
				data : {
		...
		function showpage(n) {
			...
			$
					.ajax({
						url : 'financialManagementController/getSaleTjBills.ajax',
						type : 'POST',
						data : {
							n : n,
							searchGoodsName : searchGoodsName,
												...
												$("#infoTable")
														.append(
																"<tr><td>"
																		...
																		+ val.saleTime
																		+ "</td><td>"
																		+ val.saleBillId //字符串拼接的时候遇到双引号要用单引号   \"member_stop加斜杠进行转义
																		+ "</td><td>"
																		+ "<a href=\"view/saleStatistics/saleStatistics-look.jsp?searchGoodsName="
																		+ val.commodityName
																		+ "\">查看详情</a>"
																		+ "</td></tr>");
											});
