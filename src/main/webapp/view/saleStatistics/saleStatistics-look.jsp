...
<body class="layui-anim layui-anim-up">
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a>商品销售统计</a> <a> <cite>商品销售详情</cite></a>
		...
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so">
				<div class="layui-input-inline">
					<span>查询客户：</span><input type="text" placeholder="商品名称"
						autocomplete="off" class="layui-input" id="searchGoodsName"
						value="<%=request.getParameter("searchGoodsName") %>"> 
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$.ajax({
				url : 'moneyTableController/getSpxsTjParticularsPage.ajax',
				type : 'POST',
				data : {
		...
		function showpage(n) {
			//显示页面内容
			$.ajax({
				url : 'moneyTableController/getSpxsTjBills.ajax',
				type : 'POST',
				data : {
					n : n,
					searchGoodsName : searchGoodsName					
