...
<body>
    <div class="x-body layui-anim layui-anim-up">
         <form class="layui-form">     
          <input type="hidden" id="orderReceipts" value="<%=request.getParameter("orderReceipts") %>">
...
<script>
	$(function(){
		/* 获取商品信息 */
		var orderReceipts = $("#orderReceipts").val();
		$.ajax({
			type:"POST",
			url:"<%=basePath%>orderController/getDetail.do",
			data:{	
			...
			success:function(result){
				...
				$.each(jselect,function(n,element){    
					$("#orderTableBody").append(
							...
							+ element.orderAmount + "</td><td>"
							+ element.commodityPrice +  "</td><td>"
							+ element.commodityTotalPrice + "</td></tr>"
					);
				});
			},
			error: function(){
