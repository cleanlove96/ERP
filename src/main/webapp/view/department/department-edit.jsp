		...
		<form>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="sectionName" value="${sf.sectionName }"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline content-box">
					<select id="L_education" tabindex="1">
						<option value="images/company.png" data-icon="images/company.png"
							id="imagescompanypng">&nbsp;</option>
						<option value="images/department.png"
							data-icon="images/department.png" id="imagesdepartmentpng">&nbsp;</option>
						<option value="images/staff.png" data-icon="images/staff.png"
							id="imagesstaffpng">&nbsp;</option>
					</select>
				</div>
			</div>
			<div class="layui-form-item">
