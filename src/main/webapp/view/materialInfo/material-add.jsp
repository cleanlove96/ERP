...
<body>
	<div class="x-body">
		<form class="layui-form" name="frm" onsubmit="return addmember()">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="materialName" autocomplete="off"
						class="layui-input" name="materialName"  lay-verify="required">
						<span id="failmaterialName"></span>
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="materialUnit" autocomplete="off"
						class="layui-input" name="materialUnit"  lay-verify="required">
						<span id="failmaterialUnit"></span>
				</div>
				<div class="layui-form-mid layui-word-aux">不能为空</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="price" autocomplete="off" 
						class="layui-input" name="price"  lay-verify="required">
						<span id="failmaterialPrice"></span>
				</div>
			</div>
		<!-- 	<div class="layui-form-item">
				<label for="L_entry" class="layui-form-label">创建时间</label>
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="创建时间"
						id="materialCreateTime"  lay-verify="required">
				</div>
			</div> -->
			<div class="layui-form-item">
	...
	<script>
		...
		function addmember() {	
			...
			var price=$("#price").val();
			/* var materialCreateTime=$("#materialCreateTime").val();	 */		
			$.ajax({
				url:'materialInfoController/materialInfoAdd.do',
				data:{
